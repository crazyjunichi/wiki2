import{B as k,R as M,aF as w,Y as S,L as V,y as D,c as h,o as d,a as g,r as v,z,d as T,m as u,t as B,aG as f,aH as b,aj as O,F as A,h as C,b as E,aI as Y,x as K,ah as m}from"./EWydNEwW.js";var X=function(n){var e=n.dt;return`
.p-togglebutton {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
...
`)},j={root:function(n){var e=n.instance;return["p-selectbutton p-component",{"p-invalid":e.$invalid}]}},q=k.extend({name:"selectbutton",theme:$,classes:j}),H={name:"BaseSelectButton",extends:w,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null}},style:q,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function W(t,n){var e=typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(!e){if(Array.isArray(t)||(e=R(t))||n){e&&(t=e);var a=0,i=function(){};return{s:i,n:function(){return a>=t.length?{done:!0}:{done:!1,value:t[a++]}},e:function(c){throw c},f:i}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
