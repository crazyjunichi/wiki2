import{B as k,R as M,ac as w,W as S,K as V,v as D,c as h,o as d,a as g,z as v,x as z,g as T,m as u,t as B,aQ as f,aU as b,al as O,F as A,r as C,b as E,aV as K,q as Y,aj as m}from"./CQZJ4TUP.js";var X=function(n){var e=n.dt;return`
.p-togglebutton {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
...
`)},q={root:function(n){var e=n.instance;return["p-selectbutton p-component",{"p-invalid":e.$invalid}]}},j=k.extend({name:"selectbutton",theme:$,classes:q}),W={name:"BaseSelectButton",extends:w,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null}},style:j,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function H(t,n){var e=typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(!e){if(Array.isArray(t)||(e=L(t))||n){e&&(t=e);var a=0,i=function(){};return{s:i,n:function(){return a>=t.length?{done:!0}:{done:!1,value:t[a++]}},e:function(c){throw c},f:i}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
